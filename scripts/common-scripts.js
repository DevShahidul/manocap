...
;(function($){
	$(function(){
        ...
        if($(window).width() > 991 ){            
            $(window).on('scroll',function(){
                if($(window).scrollTop() > 1){
                    ...
                    $('body').removeClass("scroll-move navOpen navClosed");
                    //$(".hero-wrap .scroll-arrow").fadeIn()
                }
            ...
            $('.phone-nav').click(function(){
                ...
                if($("body").hasClass('navOpen'))
                    $("body").removeClass('navClosed').addClass("navOpen");
                else
                $("body").addClass('navClosed').removeClass('navOpen');
            });
        }else{
            // Phone nav click function 
            $('.phone-nav').click(function(){
        ...
        $('div.info-wrap').find('a.info-item').on('click', function (e) {
                e.preventDefault()
                var $el = $(this),
                    id = $el.attr('href');
        ...
        setInterval(function () {
             $('.shape-wrapper').toggleClass('reset pulsing')
        }, 1000);      
